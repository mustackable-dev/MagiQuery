...
public class QueryRequestExamplesFilter : IOperationFilter
{
    public void Apply(OpenApiOperation operation, OperationFilterContext context)
    {
        ...
        {
            {
                "SingleFilter", new OpenApiExample
                {
            ...
            {
                "MultipleFilters&&", new OpenApiExample
                {
            ...
            {
                "MultipleFiltersComplex", new OpenApiExample
                {
            ...
            {
                "NestedAndNullable", new OpenApiExample
                {
            ...
            {
                "MultipleSorts", new OpenApiExample
                {
