...
[CollectionDefinition("MySqlPomeloDataCollection")]
public class MySqlPomeloDataCollection : ICollectionFixture<MySqlPomeloDataFixture>;
public sealed class MySqlPomeloDataFixture: ITestDataFixture
{
    public DataProvider Provider => DataProvider.MySqlPomelo;
