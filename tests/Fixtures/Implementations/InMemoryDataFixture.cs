...
[CollectionDefinition("InMemoryDataCollection")]
public class InMemoryDataCollection : ICollectionFixture<InMemoryDataFixture>;
public sealed class InMemoryDataFixture: ITestDataFixture
{
    public DataProvider Provider => DataProvider.InMemory;
    ...
    public InMemoryDataFixture()
    {
        ...
        _context = new(DataProvider.InMemory);
        SetUpDatabase();
